...
class RequestUrl {
    ...
    public static readonly getOnePaeProjectTasks = this.baseUrl + this.taskController + "getOnePage";
    ...
    public static readonly getRoles = this.baseUrl + this.roleController + "getAll";
    public static readonly getOnePageRoles = this.baseUrl + this.roleController + "getOnePage";
}
...
export default class RequestUtils {
    ...
    public static async getHeatMap(userUUID: String): Promise<Array<HeatMapData>> {
